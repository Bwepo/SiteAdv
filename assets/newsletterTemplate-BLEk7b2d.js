const o=[/permission denied/i,/not authorized/i,/not allowed/i,/row-level security/i,/requires authentication/i,/insufficient privilege/i],s=new Set(["42501","PGRST301","PGRST302","PGRST401","PGRST403"]);function r(t){if(!t)return!1;const e=typeof t=="string"?t:t instanceof Error||typeof t.message=="string"?t.message:"",i=typeof t.code=="string"?t.code:void 0,a=typeof t.status=="number"?t.status:void 0;return i&&s.has(i)||a&&[401,403].includes(a)?!0:o.some(n=>n.test(e))}function d(t,e){return r(t)?"Sem permissão.":t instanceof Error&&t.message?t.message:typeof t=="string"&&t.trim()?t:e}function l({title:t,content:e,coverImageUrl:i,postUrl:a}){const n=i?`<tr>
        <td style="padding:0;">
          <img src="${i}" alt="${t}" width="600"
